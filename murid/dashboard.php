...
<head>
    ...
    <title>Halaman Belajar Siswa</title>
    ...
    <nav class="bg-white border-4 border-[#0f172a] rounded-2xl p-4 flex flex-wrap items-center justify-between shadow-[5px_5px_0px_#0f172a]">
        ...
        <div class="flex items-center gap-3">
            <div class="hidden sm:block text-right">
                <p class="text-[10px] font-900 uppercase text-slate-400">Nama Siswa</p>
        ...
        <section class="bg-[#a8ff78] border-4 border-[#0f172a] rounded-[2rem] p-6 md:p-10 shadow-[6px_6px_0px_#0f172a] relative overflow-hidden flex flex-col justify-between items-start">
            ...
            <div class="space-y-2 md:space-y-3 max-w-xl z-10">
                ...
                <h1 class="text-2xl sm:text-3xl md:text-5xl font-900 tracking-tight text-[#0f172a] uppercase leading-none">
                    SELAMAT DATANG DI <br>APLIKASI PEMBELAJARAN
                </h1>
                <p class="text-slate-800 text-xs md:text-sm font-700 leading-relaxed pt-1">
                    Silakan pilih menu di bawah ini untuk membaca materi yang telah disediakan atau memeriksa tugas harian yang harus diselesaikan.
                </p>
            </div>
        </section>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <a href="materi.php" class="group bg-white border-4 border-[#0f172a] p-6 md:p-8 rounded-[2rem] shadow-[5px_5px_0px_#0f172a] hover:shadow-[10px_10px_0px_#a8ff78] hover:bg-[#f8fafc] transition-all hover:-translate-x-2 hover:-translate-y-2 active:translate-x-0 active:translate-y-0 flex flex-col justify-between min-h-[260px] md:min-h-[310px] bouncy-bounce">
                <div>
                    <div class="flex justify-between items-start">
                        <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-slate-50 border-2 md:border-3 border-[#0f172a] flex items-center justify-center shadow-[2px_2px_0px_#0f172a] group-hover:rotate-12 group-hover:bg-white bouncy-bounce">
                            <svg class="w-5 h-5 md:w-6 md:h-6 text-[#0c4cb4]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 class="text-xl md:text-2xl font-900 text-[#0f172a] mt-6 md:mt-8 tracking-tight uppercase">Materi Pelajaran</h2>
                    <p class="text-slate-500 text-xs font-700 mt-2 leading-relaxed">
                        Buka bagian ini untuk membaca buku digital, ringkasan materi, serta modul bimbingan yang dibagikan oleh guru kelas.
                    </p>
                </div>
            ...
            <a href="tugas.php" class="group bg-white border-4 border-[#0f172a] p-6 md:p-8 rounded-[2rem] shadow-[5px_5px_0px_#0f172a] hover:shadow-[10px_10px_0px_#a8ff78] hover:bg-[#f8fafc] transition-all hover:-translate-x-2 hover:-translate-y-2 active:translate-x-0 active:translate-y-0 flex flex-col justify-between min-h-[260px] md:min-h-[310px] bouncy-bounce">
                <div>
                    ...
                    <h2 class="text-xl md:text-2xl font-900 text-[#0f172a] mt-6 md:mt-8 tracking-tight uppercase">Tugas Siswa</h2>
                    <p class="text-slate-500 text-xs font-700 mt-2 leading-relaxed">
                        Periksa daftar latihan soal harian, perhatikan batas waktu pengumpulan, dan kirimkan berkas lembar jawaban Anda.
                    </p>
                </div>
                <div class="mt-6 flex items-center gap-2 text-xs font-900 text-[#0c4cb4] group-hover:text-emerald-700 tracking-widest uppercase transition-colors">
            ...
            <a href="tugas_saya.php" class="group bg-white border-4 border-[#0f172a] p-6 md:p-8 rounded-[2rem] shadow-[5px_5px_0px_#0f172a] hover:shadow-[10px_10px_0px_#a8ff78] hover:bg-[#f8fafc] transition-all hover:-translate-x-2 hover:-translate-y-2 active:translate-x-0 active:translate-y-0 flex flex-col justify-between min-h-[260px] md:min-h-[310px] bouncy-bounce sm:col-span-2 md:col-span-1">
                <div>
                    ...
                    <h2 class="text-xl md:text-2xl font-900 text-[#0f172a] mt-6 md:mt-8 tracking-tight uppercase">Riwayat & Nilai</h2>
                    <p class="text-slate-500 text-xs font-700 mt-2 leading-relaxed">
                        Pantau daftar perolehan nilai dari tugas yang sudah dikerjakan serta periksa catatan evaluasi dari guru pembimbing.
                    </p>
                </div>
                <div class="mt-6 flex items-center gap-2 text-xs font-900 text-[#0c4cb4] group-hover:text-emerald-700 tracking-widest uppercase transition-colors">
